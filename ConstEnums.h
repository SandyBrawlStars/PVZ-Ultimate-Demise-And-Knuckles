...
enum BackgroundType
{
    ...
    BACKGROUND_5_ROOF,
    BACKGROUND_6_BOSS,
    BACKGROUND_7_BACKYARD,
    BACKGROUND_8_ANCIENT,
...
enum GameMode
{
    ...
    GAMEMODE_UPSELL,
    GAMEMODE_INTRO,
    GAMEMODE_LONE_GATLING,
    GAMEMODE_LONE_STARFRUIT,
    GAMEMODE_CHALLENGE_ONESODDED,
    NUM_GAME_MODES
};
enum GameObjectType
{
...
enum ProjectileType
{
    ...
    PROJECTILE_ICECABBAGE = 14,
    PROJECTILE_ZOMBIE_SPIKE = 15,
    PROJECTILE_ZOMBIE_HYPNO_PEA = 16,
    PROJECTILE_ZOMBIE_SNOW_PEA = 17,
    PROJECTILE_GOO_PEA = 18,
    PROJECTILE_HYPNO_BLAST = 19,
    PROJECTILE_ZOMBIE_MELON = 20,
    PROJECTILE_ZOMBIE_BUTTER = 21,
    PROJECTILE_ZOMBIE_PUFF = 22,
    PROJECTILE_SMALLSUN = 23,
    PROJECTILE_TATER = 24,
    PROJECTILE_FROSTBOLT = 25,
    PROJECTILE_PEPPER = 26,
    PROJECTILE_HONEYDEW = 27,
    NUM_PROJECTILES = 28
};
...
enum SeedType
{
    ...
    ENUM_AUTO_VALUE(SEED_SHADOW_SHROOM)
    ENUM_AUTO_VALUE(SEED_MOON_LAMP)
    ENUM_AUTO_VALUE(SEED_GOO_PEA)
    ENUM_AUTO_VALUE(SEED_ICEBERG)
    ENUM_AUTO_VALUE(SEED_INFINUT)
    ENUM_AUTO_VALUE(SEED_PEPPERPULT)
    ENUM_AUTO_VALUE(SEED_HONEYDEWPULT)
    ...
    ENUM_AUTO_VALUE(SEED_SOLARPEA)
    ENUM_AUTO_VALUE(SEED_TATERPULT)
    ENUM_AUTO_VALUE(SEED_FROSTBOLT)
    ENUM_AUTO_VALUE(SEED_SUPERGATLING)
    ...
    ENUM_AUTO_VALUE(SEED_SUPER_STARFRUIT)
    ...
    ENUM_AUTO_VALUE(SEED_ZOMBIE_BLOVER_HEAD)
    ENUM_AUTO_VALUE(SEED_ZOMBIE_MINE_HEAD)
    ENUM_AUTO_VALUE(SEED_ZOMBIE_PEA_HEAD)
    ENUM_AUTO_VALUE(SEED_ZOMBIE_WALLNUT_HEAD)
    ENUM_AUTO_VALUE(SEED_ZOMBIE_ICE_SHROOM_HEAD)
    ENUM_AUTO_VALUE(SEED_ZOMBIE_SUPER_VASE_HEAD)
    ENUM_AUTO_VALUE(SEED_ZOMBIE_VASE_HEAD)
    ENUM_AUTO_VALUE(SEED_ZOMBIE_CONE_REPEATER_HEAD)
    ENUM_AUTO_VALUE(SEED_ZOMBIE_MELON_PULT_HEAD)
...
enum StoreItem
{
    ...
    STORE_ITEM_PLANT_SOLARPEA,
    STORE_ITEM_PLANT_TATERPULT,
    STORE_ITEM_PLANT_FROSTBOLT,
    STORE_ITEM_PLANT_SUPERGATLING,
    ...
    STORE_ITEM_FIRSTAID,
    STORE_ITEM_PVZ,
    STORE_ITEM_PLANT_ICEBERG,
    STORE_ITEM_PLANT_SHADOW_SHROOM,
...
enum ZombiePhase
{
    ...
    PHASE_ALLSTAR_RUNNING,
    PHASE_ALLSTAR_CRUSH,
    PHASE_ALLSTAR_WALK,
    PHASE_GARG_BOSS_IDLE,
    PHASE_GARG_BOSS_ATTACK,
    PHASE_SCAREDY_SCARED,
    PHASE_EXPLORER_EXSTINGUISHED,
};
enum ZombieType
{
    ...
    ENUM_AUTO_VALUE(ZOMBIE_CONE_REPEATER_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_SUPER_NEWSPAPER)
    ENUM_AUTO_VALUE(ZOMBIE_CACTUS_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_SUPER_JACK)
    ENUM_AUTO_VALUE(ZOMBIE_SUPER_ALLSTAR)
    ENUM_AUTO_VALUE(ZOMBIE_SUPER_HYPNO_FLAG)
    ENUM_AUTO_VALUE(ZOMBIE_SUNFLOWER_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_TWIN_SUNFLOWER_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_VASE_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_SNOW_PEA_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_ICE_SHROOM_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_SUPER_POLE_VAULTER)
    ENUM_AUTO_VALUE(ZOMBIE_MELON_PULT_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_BUTTER_PULT_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_SUPER_VASE_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_GARG_BOSS)
    ENUM_AUTO_VALUE(ZOMBIE_GIGA_FOOTBALL)
    ENUM_AUTO_VALUE(ZOMBIE_CHERRY_BUNGEE)
    ENUM_AUTO_VALUE(ZOMBIE_MINE_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_SCAREDY_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_LETTER_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_RALLY)
    ENUM_AUTO_VALUE(ZOMBIE_BLOVER_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_DISCO_GRAVE_BUSTER)
    ENUM_AUTO_VALUE(ZOMBIE_RA)
    ENUM_AUTO_VALUE(ZOMBIE_EXPLORER)
    ENUM_AUTO_VALUE(ZOMBIE_TOMB)
    ENUM_AUTO_VALUE(ZOMBIE_CAMEL)
    ENUM_AUTO_VALUE(ZOMBIE_UMBRELLA_HEAD)
