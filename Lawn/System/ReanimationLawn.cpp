...
MemoryImage* ReanimatorCache::MakeCachedPlantFrame(SeedType theSeedType, DrawVariation theDrawVariation)
{
	...
	else
	{
		...
		if (theSeedType == SeedType::SEED_PEASHOOTER || theSeedType == SeedType::SEED_FROSTBOLT  || theSeedType == SeedType::SEED_SOLARPEA     || theSeedType == SeedType::SEED_SNOWPEA || theSeedType == SeedType::SEED_REPEATER ||
			theSeedType == SeedType::SEED_LEFTPEATER || theSeedType == SeedType::SEED_GATLINGPEA || theSeedType == SeedType::SEED_SUPERGATLING || theSeedType == SeedType::SEED_GOO_PEA)
		{
...
MemoryImage* ReanimatorCache::MakeCachedZombieFrame(ZombieType theZombieType)
{
	...
	if (aZombieDef.mReanimationType == ReanimationType::REANIM_ZOMBIE)
	{
		...
		else if (theZombieType == ZombieType::ZOMBIE_UMBRELLA_HEAD)
		{
			Reanimation aReanimHead;
			aReanimHead.ReanimationInitializeType(aPosX + 72, aPosY - 12, ReanimationType::REANIM_UMBRELLALEAF);
		...
		else if (theZombieType == ZombieType::ZOMBIE_SCAREDY_HEAD)
		{
			Reanimation aReanimHead;
			aReanimHead.ReanimationInitializeType(aPosX + 72, aPosY - 12, ReanimationType::REANIM_SCRAREYSHROOM);
			aReanimHead.SetFramesForLayer("anim_idle");
			aReanimHead.OverrideScale(-1.0f, 1.0f);
			aReanimHead.Draw(&aMemoryGraphics);
			aReanim.AssignRenderGroupToTrack("Zombie_neck", RENDER_GROUP_HIDDEN);
		...
		else if (theZombieType == ZombieType::ZOMBIE_BLOVER_HEAD)
		{
			Reanimation aReanimHead;
			aReanimHead.ReanimationInitializeType(aPosX + 72, aPosY - 12, ReanimationType::REANIM_BLOVER);
			aReanimHead.SetFramesForLayer("anim_idle");
			aReanimHead.OverrideScale(-1.0f, 1.0f);
			aReanimHead.Draw(&aMemoryGraphics);
			aReanim.AssignRenderGroupToTrack("Zombie_neck", RENDER_GROUP_HIDDEN);
		...
		else if (theZombieType == ZombieType::ZOMBIE_CACTUS_HEAD)
		{
			Reanimation aReanimHead;
			aReanimHead.ReanimationInitializeType(aPosX + 72, aPosY - 2, ReanimationType::REANIM_CACTUS);
			aReanimHead.SetFramesForLayer("anim_idle");
			aReanimHead.OverrideScale(-1.0f, 1.0f);
			aReanimHead.Draw(&aMemoryGraphics);
			aReanim.AssignRenderGroupToTrack("Zombie_neck", RENDER_GROUP_HIDDEN);
		...
		{
			Reanimation aReanimHead;
			aReanimHead.ReanimationInitializeType(aPosX + 72, aPosY - 7, ReanimationType::REANIM_MELONPULT);
			aReanimHead.SetFramesForLayer("anim_idle");
			aReanimHead.OverrideScale(-1.0f, 1.0f);
			aReanimHead.Draw(&aMemoryGraphics);
			aReanim.AssignRenderGroupToTrack("Zombie_neck", RENDER_GROUP_HIDDEN);
		...
		else if (theZombieType == ZombieType::ZOMBIE_BUTTER_PULT_HEAD)
		{
			Reanimation aReanimHead;
			aReanimHead.ReanimationInitializeType(aPosX + 72, aPosY - 7, ReanimationType::REANIM_KERNELPULT);
			aReanimHead.SetFramesForLayer("anim_idle");
			aReanimHead.OverrideScale(-1.0f, 1.0f);
			aReanimHead.Draw(&aMemoryGraphics);
			aReanim.AssignRenderGroupToTrack("Zombie_neck", RENDER_GROUP_HIDDEN);
		...
		else if (theZombieType == ZombieType::ZOMBIE_SNOW_PEA_HEAD)
		{
			Reanimation aReanimHead;
		...
		else if (theZombieType == ZombieType::ZOMBIE_ICE_SHROOM_HEAD)
		{
			Reanimation aReanimHead;
		...
		{
			Reanimation aReanimHead;
			aReanimHead.ReanimationInitializeType(aPosX + 72, aPosY - 2, ReanimationType::REANIM_SUNFLOWER);
			aReanimHead.SetFramesForLayer("anim_head_idle");
			aReanimHead.OverrideScale(-1.0f, 1.0f);
			aReanimHead.Draw(&aMemoryGraphics);
			aReanim.AssignRenderGroupToTrack("Zombie_neck", RENDER_GROUP_HIDDEN);
		...
		else if (theZombieType == ZombieType::ZOMBIE_TWIN_SUNFLOWER_HEAD)
		{
			Reanimation aReanimHead;
			aReanimHead.ReanimationInitializeType(aPosX + 72, aPosY - 2, ReanimationType::REANIM_TWIN_SUNFLOWER);
			aReanimHead.SetFramesForLayer("anim_idle");
			aReanimHead.OverrideScale(-1.0f, 1.0f);
			aReanimHead.Draw(&aMemoryGraphics);
			aReanim.AssignRenderGroupToTrack("Zombie_neck", RENDER_GROUP_HIDDEN);
		...
		else if (theZombieType == ZombieType::ZOMBIE_CONE_REPEATER_HEAD)
		{
			Reanimation aReanimHead;
		...
		else if (theZombieType == ZombieType::ZOMBIE_GATLING_HEAD || theZombieType == ZombieType::ZOMBIE_SUPER_HYPNO_FLAG)
		{
			...
			aReanim.AssignRenderGroupToTrack("anim_head2", RENDER_GROUP_HIDDEN);
			aReanim.AssignRenderGroupToTrack("anim_hair", RENDER_GROUP_HIDDEN);
			aReanim.AssignRenderGroupToTrack("anim_bucket", RENDER_GROUP_NORMAL);
		}
