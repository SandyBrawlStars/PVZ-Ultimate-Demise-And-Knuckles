...
namespace Sexy
{
	...
	extern Image* IMAGE_BACKGROUND8_GAMEOVER_INTERIOR_OVERLAY;
	extern Image* IMAGE_BACKGROUND8_GAMEOVER_MASK;
	...
	extern Image* IMAGE_HONEYDEWPULT_PARTICLES;
	extern Image* IMAGE_HONEYDEW_PUDDLE;
	...
	extern Image* IMAGE_PROJECTILEGOOPEA;
	extern Image* IMAGE_PROJECTILEICEBERG;
	...
	extern Image* IMAGE_REANIM_FROSTBOLT_ARROW;
	extern Image* IMAGE_REANIM_GARLIC_BODY2;
	extern Image* IMAGE_REANIM_GARLIC_BODY3;
	extern Image* IMAGE_REANIM_HONEYDEWPULT_PROJECTILE;
	extern Image* IMAGE_REANIM_ICEBERG_PROJECTILE;
	extern Image* IMAGE_REANIM_INFINUT_CRACKED1;
	extern Image* IMAGE_REANIM_INFINUT_CRACKED2;
	extern Image* IMAGE_REANIM_MELONPULT_MELON;
	extern Image* IMAGE_REANIM_MUMMY_BODY;
	extern Image* IMAGE_REANIM_MUMMY_BUCKET1;
	extern Image* IMAGE_REANIM_MUMMY_BUCKET2;
	extern Image* IMAGE_REANIM_MUMMY_BUCKET3;
	extern Image* IMAGE_REANIM_MUMMY_CAMEL1_1;
	extern Image* IMAGE_REANIM_MUMMY_CAMEL1_2;
	extern Image* IMAGE_REANIM_MUMMY_CAMEL1_3;
	extern Image* IMAGE_REANIM_MUMMY_CAMEL2_1;
	extern Image* IMAGE_REANIM_MUMMY_CAMEL2_2;
	extern Image* IMAGE_REANIM_MUMMY_CAMEL2_3;
	extern Image* IMAGE_REANIM_MUMMY_CAMEL3_1;
	extern Image* IMAGE_REANIM_MUMMY_CAMEL3_2;
	extern Image* IMAGE_REANIM_MUMMY_CAMEL3_3;
	extern Image* IMAGE_REANIM_MUMMY_CONE1;
	extern Image* IMAGE_REANIM_MUMMY_CONE2;
	extern Image* IMAGE_REANIM_MUMMY_CONE3;
	extern Image* IMAGE_REANIM_MUMMY_HEAD2;
	extern Image* IMAGE_REANIM_MUMMY_HEAD;
	extern Image* IMAGE_REANIM_MUMMY_INNERARM_EXTENDED;
	extern Image* IMAGE_REANIM_MUMMY_INNERARM_HAND;
	extern Image* IMAGE_REANIM_MUMMY_INNERARM_LOWER;
	extern Image* IMAGE_REANIM_MUMMY_INNERARM_UPPER;
	extern Image* IMAGE_REANIM_MUMMY_INNERLEG_FOOT;
	extern Image* IMAGE_REANIM_MUMMY_INNERLEG_LOWER;
	extern Image* IMAGE_REANIM_MUMMY_INNERLEG_UPPER;
	extern Image* IMAGE_REANIM_MUMMY_OUTERARM_HAND;
	extern Image* IMAGE_REANIM_MUMMY_OUTERARM_LOWER;
	extern Image* IMAGE_REANIM_MUMMY_OUTERARM_UPPER2;
	extern Image* IMAGE_REANIM_MUMMY_OUTERARM_UPPER;
	extern Image* IMAGE_REANIM_MUMMY_OUTERLEG_FOOT2;
	extern Image* IMAGE_REANIM_MUMMY_OUTERLEG_FOOT;
	extern Image* IMAGE_REANIM_MUMMY_OUTERLEG_LOWER;
	extern Image* IMAGE_REANIM_MUMMY_OUTERLEG_UPPER;
	extern Image* IMAGE_REANIM_MUMMY_TIE;
	extern Image* IMAGE_REANIM_PEPPERPULT_PEPPER;
	...
	extern Image* IMAGE_REANIM_TATERPULT_CABBAGE;
	...
	extern Image* IMAGE_REANIM_ZOMBIE_GIGA_FOOTBALL_HELMET;
	extern Image* IMAGE_REANIM_ZOMBIE_GIGA_FOOTBALL_LEFTARM_HAND;
	...
	extern Image* IMAGE_REANIM_ZOMBIE_RALLYFLAG1;
	extern Image* IMAGE_REANIM_ZOMBIE_RALLYFLAG2;
	...
	enum ResourceId
	{
		...
		IMAGE_PROJECTILEGOOPEA_ID,
		IMAGE_PROJECTILEICEBERG_ID,
		...
		IMAGE_HONEYDEWPULT_PARTICLES_ID,
		...
		IMAGE_DUST_PUFFS_ID,
		IMAGE_REANIM_MUMMY_HEAD_ID,
		IMAGE_REANIM_MUMMY_HEAD2_ID,
		IMAGE_REANIM_MUMMY_BODY_ID,
		IMAGE_REANIM_MUMMY_TIE_ID,
		IMAGE_REANIM_MUMMY_INNERARM_EXTENDED_ID,
		IMAGE_REANIM_MUMMY_INNERARM_HAND_ID,
		IMAGE_REANIM_MUMMY_INNERARM_LOWER_ID,
		IMAGE_REANIM_MUMMY_INNERARM_UPPER_ID,
		IMAGE_REANIM_MUMMY_INNERLEG_FOOT_ID,
		IMAGE_REANIM_MUMMY_INNERLEG_LOWER_ID,
		IMAGE_REANIM_MUMMY_INNERLEG_UPPER_ID,
		IMAGE_REANIM_MUMMY_OUTERARM_HAND_ID,
		IMAGE_REANIM_MUMMY_OUTERARM_LOWER_ID,
		IMAGE_REANIM_MUMMY_OUTERARM_UPPER_ID,
		IMAGE_REANIM_MUMMY_OUTERARM_UPPER2_ID,
		IMAGE_REANIM_MUMMY_OUTERLEG_FOOT_ID,
		IMAGE_REANIM_MUMMY_OUTERLEG_FOOT2_ID,
		IMAGE_REANIM_MUMMY_OUTERLEG_LOWER_ID,
		IMAGE_REANIM_MUMMY_OUTERLEG_UPPER_ID,
		IMAGE_REANIM_MUMMY_CONE1_ID,
		IMAGE_REANIM_MUMMY_CONE2_ID,
		IMAGE_REANIM_MUMMY_CONE3_ID,
		IMAGE_REANIM_MUMMY_BUCKET1_ID,
		IMAGE_REANIM_MUMMY_BUCKET2_ID,
		IMAGE_REANIM_MUMMY_BUCKET3_ID,
		IMAGE_REANIM_MUMMY_CAMEL1_1_ID,
		IMAGE_REANIM_MUMMY_CAMEL1_2_ID,
		IMAGE_REANIM_MUMMY_CAMEL1_3_ID,
		IMAGE_REANIM_MUMMY_CAMEL2_1_ID,
		IMAGE_REANIM_MUMMY_CAMEL2_2_ID,
		IMAGE_REANIM_MUMMY_CAMEL2_3_ID,
		IMAGE_REANIM_MUMMY_CAMEL3_1_ID,
		IMAGE_REANIM_MUMMY_CAMEL3_2_ID,
		IMAGE_REANIM_MUMMY_CAMEL3_3_ID,
		IMAGE_REANIM_WALLNUT_BODY_ID,
		IMAGE_REANIM_WALLNUT_CRACKED1_ID,
		IMAGE_REANIM_WALLNUT_CRACKED2_ID,
		IMAGE_REANIM_INFINUT_CRACKED1_ID,
		IMAGE_REANIM_INFINUT_CRACKED2_ID,
		...
		IMAGE_REANIM_ZOMBIE_RALLYFLAG1_ID,
		IMAGE_REANIM_ZOMBIE_RALLYFLAG2_ID,
		...
		IMAGE_REANIM_ZOMBIE_GIGA_FOOTBALL_HELMET_ID,
		...
		IMAGE_REANIM_ZOMBIE_GIGA_FOOTBALL_LEFTARM_HAND_ID,
		...
		IMAGE_REANIM_PEPPERPULT_PEPPER_ID,
		IMAGE_REANIM_HONEYDEWPULT_PROJECTILE_ID,
		IMAGE_REANIM_TATERPULT_CABBAGE_ID,
		IMAGE_REANIM_ICEBERG_PROJECTILE_ID,
		IMAGE_REANIM_FROSTBOLT_ARROW_ID,
		...
		IMAGE_BACKGROUND8_GAMEOVER_INTERIOR_OVERLAY_ID,
