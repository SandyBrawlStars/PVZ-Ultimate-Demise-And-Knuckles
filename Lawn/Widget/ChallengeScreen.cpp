...
ChallengeDefinition gChallengeDefs[NUM_CHALLENGE_MODES] = {
	...
	{ GameMode::GAMEMODE_PUZZLE_I_ZOMBIE_10,                    11,  ChallengePage::CHALLENGE_PAGE_PUZZLE,      3,  4,  _S("Harsh Winds") },
	{ GameMode::GAMEMODE_PUZZLE_I_ZOMBIE_ENDLESS,              11,  ChallengePage::CHALLENGE_PAGE_PUZZLE,      4,  4,  _S("[I_ZOMBIE_ENDLESS]") },
...
int ChallengeScreen::AccomplishmentsNeeded(int theChallengeIndex)
{
	...
	if (mApp->IsSurvivalEndless(aGameMode) && aTrophiesNeeded <= 3 && mApp->GetNumTrophies(CHALLENGE_PAGE_SURVIVAL) < 11 &&
